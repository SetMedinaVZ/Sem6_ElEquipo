...
import Edit from "../../assets/icons/editBtn.svg";
import Save from "../../assets/icons/saveBtn.svg";
...
function Perfil() {
  ...
  const [telefono, setTelefono] = useState("00-00000000");
  ...
  const getUserInfo = async () => {
    ...
    if (userSnap.exists()) {
      ...
      setFullName(`${userSnap.data().nombre} ${userSnap.data().apellido}`);
      setEmail(userSnap.data().email);
      setTelefono(userSnap.data().telefono);
      let seconds = userSnap.data().fechaNacimiento.seconds;
      const currentDate = new Date();
      currentDate.setTime(seconds * 1000);
    ...
    <>
      <div className="container">
        ...
        <InputDiv className="CodigoUsuario">
          ...
          <Codigo placeholder="93840283" disabled></Codigo>
        </InputDiv>
